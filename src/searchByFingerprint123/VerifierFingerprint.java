...
/**
 * Servlet implementation class VerifierFingerprint
 */
@WebServlet("/VerifierFingerprint")
public class VerifierFingerprint extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public VerifierFingerprint() {
        super();
				...
				try {
		            ...
		            if(badImageQuality==1){
			            ...
			            try{
			    			...
			    			out1.close();
			    			/*add fingerprint*/
			    			dao.update_fingerprint_Ver(false,fingerprint_byte, fname, lname, mun);
							dao.add_logs(false, date, time, "Verifier from "+municipality+" named "+lname+", "+fname+" change its fingerprint by "+session.getAttribute("username"));
