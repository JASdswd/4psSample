...
/**
 * Servlet implementation class BookKeeperFingerprint
 */
@WebServlet("/BookKeeperFingerprint")
public class BookKeeperFingerprint extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BookKeeperFingerprint() {
        super();
		...
		if(session==null){
			...
			if(session.getAttribute("username")==null){
				...
				try {
					...
					System.out.println("BKFingerprint:");
		            ...
		            if(badImageQuality==1){
			            ...
			            try{
			    			...
			    			out1.close();
			    			/*add fingerprint*/
			    			dao.update_fingerprint_BK(false,fingerprint_byte, fname, lname, mun);
							dao.add_logs(false, date, time, "Book Keeper from "+municipality+" named "+lname+", "+fname+" change its fingerprint by "+session.getAttribute("username"));
