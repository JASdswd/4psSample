...
/**
 * Servlet implementation class BookKeeperConfirmation
 */
@WebServlet("/BookKeeperConfirmation")
public class BookKeeperConfirmation extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BookKeeperConfirmation() {
        super();
    }
		...
		if(session==null){
			...
			if(session.getAttribute("username")==null){
				...
				try {
					...
					boolean check_password = dao.check_passwordbookKeeper(request.getParameter("user"), hashpword,4);
					if(check_password){
