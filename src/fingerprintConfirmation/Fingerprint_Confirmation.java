...
/**
 * Servlet implementation class Fingerprint_Confirmation
 */
@WebServlet("/Fingerprint_Confirmation")
public class Fingerprint_Confirmation extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Fingerprint_Confirmation() {
        super();
				...
				try{
						 ...
						 try {
			        			...
			        			try {
			        				...
			        				bean = dao.getuser_fingerprint(false);
