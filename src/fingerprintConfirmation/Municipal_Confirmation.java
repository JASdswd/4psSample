...
/**
 * Servlet implementation class Municipal_Confirmation
 */
@WebServlet("/Municipal_Confirmation")
public class Municipal_Confirmation extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Municipal_Confirmation() {
        super();
				...
				try{
						 ...
						 try {
			        			...
			        			try {
			        				...
			        				int municality_id = dao.get_municipality_id(false, (String)request.getParameter("household_id"));
			        				list = dao.getmunuser_fingerprint(false,municality_id);
			        				System.out.println("ldjdjd"+list.size());
			    				...
			    				for(transactionBean l: list){
			    					...
			    					if (result.isVerified()){
			    						...
			    						controller = 1;
			    						munuserId = l.getMunlinkUser_id();
			    						System.out.println("mun"+munuserId);
			    						
			    					}
			    				}
			    				
			        			if(controller>0){
			        				System.out.println("fingerprint matched. "+munuserId);
			        				Fingerprint_conDAO d = new Fingerprint_conDAO();
			        				d.updatesub((String)request.getParameter("household_id"), munuserId, (String)request.getParameter("month"));
