	...
	$.fn.tablePagination = function(settings) {
      ...
      function createPaginationElements() {
       ...
       /* htmlBuffer.push("per page");*/
        ...
        htmlBuffer.push("<button id='tablePagination_firstPage' class='first'>First</button>");
        htmlBuffer.push(" <button class='prev' id='tablePagination_prevPage'>Prev</button>");
        ...
        htmlBuffer.push("<button class='next' id='tablePagination_nextPage'>Next</button>");
        htmlBuffer.push("<button class='last' id='tablePagination_lastPage'>Last</button>");
        htmlBuffer.push("</span>");
        htmlBuffer.push("</div>");
