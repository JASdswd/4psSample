 ...
 */
 (function($){
	...
	$.fn.tablePagination = function(settings) {
      ...
      firstPageId = '#tablePagination_firstPage2';
      prevPageId = '#tablePagination_prevPage2';
      nextPageId = '#tablePagination_nextPage2';
      lastPageId = '#tablePagination_lastPage2';
      ...
      function createPaginationElements() {
       ...
       /* htmlBuffer.push("per page");*/
        ...
        htmlBuffer.push("<button id='tablePagination_firstPage2' class='first'>First</button>");
        htmlBuffer.push(" <button class='prev' id='tablePagination_prevPage2'>Prev</button>");
        ...
        htmlBuffer.push("<button class='next' id='tablePagination_nextPage2'>Next</button>");
        htmlBuffer.push("<button class='last' id='tablePagination_lastPage2'>Last</button>");
        htmlBuffer.push("</span>");
        htmlBuffer.push("</div>");
